...
\name{Matteo}{Castellucci}
\position{Master's Degree student in ``Ingegneria e Scienze Informatiche"}
%\address{42-8, Bangbae-ro 15-gil, Seocho-gu, Seoul, 00681, Rep. of KOREA}

%\mobile{(+82) 10-9030-1843}
\email{matteo.castellucci@outlook.com}
\dateofbirth{December 14th, 1998}
...
\makecvfooter
  {\today}
  {Matteo Castellucci~~~·~~~Curriculum Vitae}
  {\thepage}
